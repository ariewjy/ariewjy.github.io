...
There should be an **asterisk** on a narrative that countries can grow their economy while also reducing emission - **Only when they are rich**.

A country needs **energy to grow** their economy, the higher the energy consumption the higher the CO~2~ emission would be. The narrative that a country emits more CO~2~ because they are rich can be **misleading**. It is the **other way around**.
...
Furthermore, as a counter to "**only rich countries was able to decoupled**" - let's see if there is a country, with large population (above 100mil), that are not categorized as rich country (above 4500 GDP per capita), that was able to decoupled their economy from emissions?
...
Only three countries, in the **entire world** - that was able to decoupled, when the population is at least 100 million. **None of them** is below the upper-middle income class. Their GDP is already above 10,000 USD before they can start to decoupled their economy from emissions.
