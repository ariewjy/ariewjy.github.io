...
![Foto Dermaga. Rogaland adalah nama Provinsi dari Stavanger (bagian dari Provinsi)](images/rogaland_ship.jpeg){width="720"}

::: callout-note
-   Artikel ini diperbaharui sesuai dengan tanggal terkahir modifikasi di atas. Artikel merupakan pengalaman pribadi penulis/ interaksi penulis dengan rekan kerja dan/ teman, dan bisa saja berbeda dengan pengalaman anda. Harap melakukan pengecekan sendiri terlebih dahulu, karena penulis tidak bertanggungjawab atas ketidaksesuaian isi artikel terhadap pengalaman yang anda dapatkan.

-   Penulis akan memakai penyebutan kata Stavanger dan Norway setara, kecuali disebutkan secara spesifik. Hal ini dikarenakan banyak hal yang merupakan peraturan negara (Norway), namun ada juga beberapa hal spesifik (lokal) yang hanya ada di Stavanger.
:::
...
![D-Num](images/D-num.png){width="480"}
...
![P-num](images/P-num.png){width="480"}
...
![Halte Bus Bandara](images/flybussen.png){width="680"}
...
![Jadwal Bus Bandara](images/flybussen_time.png){width="720"}
...
![Bus Bandara](images/flybussen_payment.png){width="720"}
...
![Aplikasi Tiket Bis](images/kolumbus_billet.png){width="720"}
...
![Aplikasi Bis](images/kolumbus_app.png){width="720"}

Per tahun 2024, Kolumbus mulai menerapkan sistem pas-as-you-go, dimana kita ditagih per trip, yang biaya totalnya di akhir bulan tidak akan melebih biaya tiket bulanan/ mingguan (tergantung nanti pemakaian kita). Semakin sering kita melakukan perjalanan via bis, diskon yang diterapkan akan semakin besar. Pada awal-awal trip, maka diskon mungkin kecil (cuma beberapa persen, seperti foto dibawah, cuma 1%).

![](images/trip_bus.jpeg){width="50%"}

Seperti contoh di bawah, pemakaian saya di bulan April 2024 dibatasi di angka 680Kr (harga tiket bulanan), karena saya full pemakaian, dan ada trip ampai tanggal terakhir di bulan April. Sedangkan di bulai berikutnya (May), karena saya cuma memakai aplikasi, dan trip terakhir cuma sampai minggu pertama bulan May - maka maksimal di angka tiket mingguan (270Kr). Dapat dilihat juga, kalau ketika trip kita sudah cukup banyak, sehingga biayanya sudah mendekati/ sama dengan harga tiket bulanan/mingguan, maka diskon perjalanan bisa sampai 100%, cuma membayar 0Kr. 

::: {layout-ncol="2"}
![Apr](images/trip_april.PNG){width="100%"}

![May](images/trip_may.PNG){width="100%"}
:::
...
![Rute](images/gmap.png){width="720"}
...
![Wise](images/wise_card.png){width="480"}
...
![Vipps](images/vipps.png){width="720"}
...
![](images/local_mobile_package.png)
...
![Mailbox](images/mailbox.png){width="480"}
...
![Contoh Residence Card](images/residence_card.png)
...
![Beragam Digital ID](images/digital_id.png){width="535"}
...
![MinID](images/minID.png){width="320"}
...
![Buypass](images/buypass.png){width="480"}
...
![Sparebank1 Website](images/sparebank1sr.png){width="901"}
...
![Altinn Website](images/altinn.png){width="720"}
...
![Emergency](images/legevakt){width="720"}
...
::: callout-note
Per 2024, tunjangan anak dinaikkan menjadi sekitar 1900 NOK!
:::

![](images/nav.png){width="670"}

## Sekolah Anak

### Barnehage (Daycare+Playgroup)

Di Norway, anak di bawah 7 tahun wajib masuk Barnehage (daycare + playgroup). Pendidikan wajib di Norway, dan merupakan hak anak dan kewajiban orangtua untuk mendaftarkan. Biaya barnehage ini sekitar 3,000 NOK per bulannya, belum termasuk uang makan siang (sekitar 300-500NOK). Minimal e-ID adalah MinID untuk masuk ke website pendaftaran [Vigilo](https://vigilo.no/).

::: callout-note
Per 2024, biaya barnehage turun menjadi 2,000 NOK!
:::

![Halaman Utama](images/vigiilo.png){width="720"}
...
![Pendaftaran](images/vigilo-applications.png)
...
![Nominasi](images/vigilo-childcare-places.png)
...
![Extra](images/extra.png){width="720"}

![REMA1000](images/rema1000.png){width="720"}
...
![IMS](images/IMS.png){fig-alt="Foto dari Google Maps" width="720"}

![Istanbul Import](images/istanbul_import.png){width="720"}
...
![Finn No](images/finn_no.gif)

## Berapa Biaya Hidup di Norway?

![](images/biayahidup.png){width="538"}
...
![](images/norway_tax.png)Patut dipahami, bahwa pajak di Norway dihitung per tahun, namun diambil sebanyak 10.5 bulan, karena pajak di bulan May-Jun adalah 0%, sedangkan di bulan-bulan masuk Winter senilai 50% dari nilai aslinya, sehingga 12-1.5=10.5. Kenapa ini penting? Karena nilai pajak anda per bulan akan menjadi lebih besar dari hitungan per tahun dibagi 12 bulan.
